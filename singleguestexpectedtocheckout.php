...
<title>list of single reservation guest expected to checkout today</title>
...
<div id="content">
<?php
$select=$object->query("SELECT * FROM `single` WHERE `checkout_date`=CURDATE() AND `checkout`='0' ORDER BY 'surname' DESC");
...
?>
<fieldset>
<legend><center><h4><font color="#FF0000"><p><b>List of Single Guest Expected To Checkout Today</b></p></font></h4></center></legend>
