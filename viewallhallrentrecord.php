...
<title>view all hall rental record</title>
...
<?php
$laund=$object->query("SELECT *  FROM `hallrental` ");
?>
<legend><b>View All Hall Rental Record</b></legend>
<?php
if(mysql_num_rows($laund)==0){echo "No Hall Rental Records";}
...
<center><table width="800" border="0" cellspacing="1">
        <tr>
<td><center>
  <p>Number of people that have Rented our hall so far:</p></center></td>
<td><center><b><?php echo mysql_num_rows($laund);?></b></center></td>
<td><center>Hall rental total:</center></td>
