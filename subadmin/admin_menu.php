...
<table width="100%" border="1">
  ...
  <tr>
       <td width="33%" height="184"><p><center>
      <a href="enter_room_details.php"><img src="../images/access-01.png" /><br />
      Enter Room Details</a>
       </center></p></td>
            <td width="33%" height="184"><p><center>
      <a href="enter_food_details.php"><img src="../images/restaurant-01.png" /><br />
      Enter Food Details</a>
            </center></p></td>
                 <td width="33%" height="184"><p><center>
      <a href="new_user.php"><img src="../images/single-01.png" /><br />
      Enter A New user</a>
                 </center></p></td>
...
<tr>
 <td width="33%" height="184"><p><center>
      <a href="enter_acccountdate_form.php">
   <img src="../images/rec11-01.png" /><br />
   View Account By Date</a> </center></p></td>
   
 <td width="33%" height="184"><p><center>
      <a href="empty.php">
   <img src="../images/bin.jpg" /><br />
   Empty Hotel Records</a> </center></p></td>
   
    <td width="33%" height="184"><p><center>
      <a href="select_edit_menu.php">
   <img src="../images/recycle.jpg" /><br />
   Edit</a> </center></p></td>
   </tr>
      </table>
</div>
