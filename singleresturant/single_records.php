...
<td align="center" width="9%"></td> <td width="91%"><a style="color:#000;" href="../logout.php">logout</a>  | <a href="../singleresturant/resmenu.php" style="color:#000;">Home</a></td> 
 </tr>
 </table></center>
<?php
		$id=$_GET['id'];
...
<td>N<?php 
echo "<p class='orange'>".number_format($gymtotal, 2)."</p>" ;?></td>
<td></td>
