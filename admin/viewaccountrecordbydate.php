...
<center><table width="90%" border="1" cellspacing="1" cellpadding="10px">
  ...
  <td><?php $single=$object->query("SELECT * FROM `accountbalance` WHERE `entrydate`='$checkdate' AND `checkout`='0'"); 
  while($l=mysql_fetch_array($single))
  { $singletotal+=$l['initial_deposit'];
  }
?>
<?php $refund=$object->query("SELECT * FROM `accountbalance` WHERE `entrydate`='$checkdate' AND `checkout`='1'"); 
  while($l=mysql_fetch_array($refund))
  { $singlerefundtotal+=$l['refund'];
  }
  ?>
  <?php $balance=$object->query("SELECT * FROM `accountbalance` WHERE `entrydate`='$checkdate' AND `checkout`='1'"); 
...
?>
  ...
  <td><?php $group=$object->query("SELECT * FROM `groupaccountbalance` WHERE `entrydate`='$checkdate' AND `checkout`='0'"); 
  while($gl=mysql_fetch_array($group))
  { $grouptotal+=$gl['initial_deposit'];
  }
?>
<?php $grouprefund=$object->query("SELECT * FROM `groupaccountbalance` WHERE `entrydate`='$checkdate' AND `checkout`='1'"); 
  while($rl=mysql_fetch_array($grouprefund))
  { $grouprefundtotal+=$rl['refund'];
  }
  ?>
  <?php $groupbalance=$object->query("SELECT * FROM `groupaccountbalance` WHERE `entrydate`='$checkdate' AND `checkout`='1'"); 
...
?>
  ...
  <td>
<?php $resturant=$object->query("SELECT * FROM `singleresturant` WHERE `entrydate`='$checkdate'"); 
  while($l=mysql_fetch_array($resturant))
  { $resturanttotal+=$l['cost'];
  }
    $groupresturant=$object->query("SELECT * FROM `groupresturant` WHERE `entrydate`='$checkdate'"); 
  while($t=mysql_fetch_array($groupresturant))
  { $groupresturanttotal+=$t['cost'];
  }
  $outsideresturant=$object->query("SELECT * FROM `outsideresturant` WHERE `entrydate`='$checkdate'"); 
...
?>
  ...
  <td height="51">GYM</td>
  <td>
<?php $gym=$object->query("SELECT * FROM `singlegym` WHERE `entrydate`='$checkdate' "); 
  while($l=mysql_fetch_array($gym))
  { $gymtotal+=$l['cost'];
  }
  $groupgym=$object->query("SELECT * FROM `groupgym` WHERE `entrydate`='$checkdate' "); 
  while($l=mysql_fetch_array($groupgym))
  { $groupgymtotal+=$l['cost'];
  }
   $outsidegym=$object->query("SELECT * FROM `outsidegym` WHERE `entrydate`='$checkdate' "); 
...
?>  </td> 
  ...
  <td>
<?php $laundry=$object->query("SELECT * FROM `singlelaundry` WHERE `entrydate`='$checkdate' "); 
  while($l=mysql_fetch_array($laundry))
  { $laundrytotal+=$l['amount'];
  }
   $grouplaundry=$object->query("SELECT * FROM `grouplaundry` WHERE `entrydate`='$checkdate' "); 
  while($l=mysql_fetch_array($grouplaundry))
  { $grouplaundrytotal+=$l['amount'];
  }
   $outlaundry=$object->query("SELECT * FROM `outsidelaundry` WHERE `entrydate`='$checkdate' "); 
...
?>
  ...
  <td>
<?php $eventcenter=$object->query("SELECT * FROM `event_centre` WHERE `entry_date`='$checkdate'"); 
  while($l=mysql_fetch_array($eventcenter))
  { $eventcentertotal+=$l['amount_paid'];
  }
...
?></td>  
  ...
  <td>
<?php $hallrental=$object->query("SELECT * FROM `hallrental` WHERE `entry_date`='$checkdate'"); 
...
?></td>  
  ...
  <tr>
  <td><?php $hoteltodaystotal=$laundrytotal+$gytotal+$restotal+$grouptotalcpm+$total;   ?></td>
