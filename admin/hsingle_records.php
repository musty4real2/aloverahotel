...
<?php
		...
		$single=$object->query("SELECT * FROM `group` WHERE `id` ='$id' AND`checkout`='1' ");

		
		
        
		$rest=$object->query("SELECT *  FROM `groupresturant` WHERE `guestid`='$id'  AND`checkout`='1' ");
	
	
		$gym=$object->query("SELECT *  FROM `groupgym` WHERE `guestid`='$id'  AND`checkout`='1' ");

		$laund=$object->query("SELECT * FROM `grouplaundry` WHERE `guestid`='$id'  AND`checkout`='1' ");
