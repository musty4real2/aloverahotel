...
<div id="content">
<?php
$select=$object->query("SELECT * FROM `single` WHERE `checkout`='1' ORDER BY 'surname' DESC");
...
<center><table width="90%" border="1" cellspacing="1" cellpadding="10px">
  ...
  <?php
    ...
    <td><?php echo $object->getRoomLocation($roomid); ?></td>
            <?php echo "<td><a href='hhsingle_records.php?id=$id&roomid=$roomid'>View Guest Record</a></td>"; ?> 
