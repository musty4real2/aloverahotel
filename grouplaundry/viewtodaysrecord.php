...
<title>Veiw Today's group laundry  Record</title>
...
?>
  ...
  $q = "SELECT * FROM `grouplaundry` WHERE `entrydate`= CURDATE() AND `checkout`='0' ";
  $r = mysql_query ($q);
...
$fetch="SELECT * FROM `grouplaundry` WHERE `entrydate`= CURDATE() AND `checkout`='0' ORDER BY `time` ASC LIMIT $start, $display ";
