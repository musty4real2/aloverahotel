...
$a=$object->query("INSERT INTO `groupresturant` (`guestid`, `food_id`, `plate`, `cost`, `entrydate`, `time`, `waiter`) 
VALUES('$name', '$idfood', '$plate', '$cost', NOW(), NOW(),'$waiter')");
 header("location:temp_group_resturant_reciept.php?name=$name&foodid=$idfood&plate=$plate&waiter=$waiter&cost=$cost");
...
$surname=$row['surname'];
$oname=$row['othername'];
echo "<option value='$id'>$surname , $oname from ( $cname )</option>";
}
 ?>
 </select>
