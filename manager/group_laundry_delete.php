...
echo 'Do You Really Want To Delete Guest With ID of '.$_GET['deleteid'].'? <a href="group_laundry_delete.php?yesdelete='.$_GET['deleteid'].'">Yes </a>| <a href="single_resturant_delete.php">No</a>';
exit();
...
if(isset($_GET['yesdelete'])){
	...
	$sql=mysql_query("DELETE FROM `grouplaundry` WHERE `guestid`='$id_to_delete' limit 1") or die(mysql_error());
	
	header("location:group_laundry_delete.php");
	exit();
}
...
<center><table width="95%" border="1" cellspacing="1">
  ...
  <?php
	...
	?>
		<?php echo "<td><a href='single_records.php?id={$l['guestid']}&roomid=$roomid''>View Guest Record</a></td>"; ?> 
<?php echo "<td><a href='group_laundry_delete.php?deleteid={$l['guestid']}'>Delete</a></td>"; ?> 
<?php echo "<td><a href='edit_group_laundry_details.php?pid={$l['guestid']}'>Edit</a></td>"; ?> 
