...
echo 'Do You Really Want To Delete Guest With ID of '.$_GET['deleteid'].'? <a href="nonguestres_delete.php?yesdelete='.$_GET['deleteid'].'">Yes </a>| <a href="single_resturant_delete.php">No</a>';
exit();
...
if(isset($_GET['yesdelete'])){
	...
	$sql=mysql_query("DELETE FROM `outsideresturant` WHERE `guestname`='$id_to_delete' limit 1") or die(mysql_error());
	
	header("location:nonguestres_delete.php");
	exit();
}
...
<center><table width="90%" border="1" cellspacing="1">
 ...
 <td><?php echo $object->getFoodCost($row['food_id']);  //shows cost of the food PER PLATE?></td>
    ...
    <?php echo "<td><a href='nonguestres_delete.php?deleteid={$row['guestname']}'>Delete</a></td>"; ?> 
