...
echo 'Do You Really Want To Delete Guest With ID of '.$_GET['deleteid'].'? <a href="groupdelete.php?yesdelete='.$_GET['deleteid'].'">Yes </a>| <a href="groupdelete.php">No</a>';
exit();
...
if(isset($_GET['yesdelete'])){
	...
	$sql=mysql_query("DELETE FROM `group` WHERE `id`='$id_to_delete' limit 1") or die(mysql_error());
...
<?php echo "<td><a href='groupdelete.php?deleteid=$id'>Delete</a></td>"; ?> 
<?php echo "<td><a href='edit_group_reservation_details.php?pid=$id'>Edit</a></td>"; ?> 
